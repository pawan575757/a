<?php
  ...
  if(isset($_POST['active'])){
    if(isset($_POST['chkbox'])){
      foreach ($_POST['chkbox'] as $key => $value) {
        $upd = "UPDATE `cat_master` SET `status`= '1' WHERE catid = ".$value; 
  ...
  if(isset($_POST['inactive'])){
      if(isset($_POST['chkbox'])){
      foreach ($_POST['chkbox'] as $key => $value) {
        $upd = "UPDATE `cat_master` SET `status`= '2' WHERE catid = ".$value;
        mysqli_query($conn,$upd);
      }
    }/*else{
      echo "<script>alert('Please select atleast one.');</script>"; 
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="add_cat.php"  class="frt btn btn-success"> <i class="fa fa-plus"></i> Add Category</a>
          </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody id="checkboxes">
                    ...
                    <tr>
                      ...
                      <td>
                      <a href="add_cat.php?id=<?php echo $value['catid']?>" class="label label-info point"><i class="fa fa-edit" data-toggle="tooltip" title="Edit Record"></i></a>  
                      ...
                      <a href="#"><i class="fa fa-trash delete" data-toggle="tooltip"  id='del_<?= $value['catid'] ?>' data-id='<?= $value['catid'] ?>'  title="Delete Record"></i></a>
