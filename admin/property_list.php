      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="add_property.php"  class="frt btn btn-success"> <i class="fa fa-plus"></i> Add Property</a>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <div class="table-responsive" >
                ...
                <table class="table  table-responsive" id="dataTable" width="100%" cellspacing="0" style="">
                  <thead>
                    <tr>
                      <th>
                        <label>
                  ...
                  <tbody id="checkboxes">
                    ...
                    <tr>
                      ...
                      <td><?php echo ucfirst($row_cat['name']);?></td>
                       <td><?php echo ucfirst($row_agent['name']);?></td>
                      ...
                      <td>
                      <a href="add_property.php?id=<?php echo $value['proid']?>" class="label label-info point"><i class="fa fa-edit" data-toggle="tooltip" title="Edit Record"></i></a>  
