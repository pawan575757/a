<?php
  ...
  if(isset($_POST['active'])){
    if(isset($_POST['chkbox'])){
      foreach ($_POST['chkbox'] as $key => $value) {
        $upd = "UPDATE `feature_master` SET `status`= '1' WHERE featureid = ".$value; 
  ...
  if(isset($_POST['inactive'])){
      if(isset($_POST['chkbox'])){
      foreach ($_POST['chkbox'] as $key => $value) {
        $upd = "UPDATE `feature_master` SET `status`= '2' WHERE featureid = ".$value;
        mysqli_query($conn,$upd);
      }
    }/*else{
      echo "<script>alert('Please select atleast one.');</script>"; 
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="add_feature.php"  class="frt btn btn-success"> <i class="fa fa-plus"></i> Add feature</a>
          </div>
            ...
            <div class="card-body">
              <div class="table-responsive" style="overflow:hidden;">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody id="checkboxes">
                    <?php
                      foreach ($res_feature as $key => $value){
                    ?>
                    <tr>
                      <td>  
                        <?php
                          if(!empty($value['featureid']))
                          {
                      ...
                      <td>
                      <a href="add_feature.php?id=<?php echo $value['featureid']?>" class="label label-info point"><i class="fa fa-edit" data-toggle="tooltip" title="Edit Record"></i></a>  
                      ...
                      <a href="#"><i class="fa fa-trash delete" data-toggle="tooltip"  id='del_<?= $value['featureid'] ?>' data-id='<?= $value['featureid'] ?>'  title="Delete Record"></i></a>
