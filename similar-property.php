...
//................................ Property Table -------------------------------//
  $selectquery = " select * from property where status = 1 AND locationid =" .$res['locationid'] ;
...
?>
        ...
        <div class="col-lg-5 col-md-12 col-12 col-sm-12 col-12 p-0">
               <a href="prop-desc.php?mid=<?php echo $res['proid'];?>"><img class="d-none d-lg-block d-xl-block" src="admin/images/<?php echo strtr($name[0],'[]','++'); ?>" alt="..." style="width: 100%;height: 282px;object-fit: fill;object-position: center;border-top-left-radius: 15px;border-bottom-left-radius: 15px;">
               </a>
