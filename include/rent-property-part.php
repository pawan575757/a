...
//................................ Property Table -------------------------------//
 $selectquery= " select * from property WHERE property.catid = {$cat_id} AND typeid = 2 ORDER BY property.proid DESC LIMIT 20 " ;   
...
?>
        ...
        <div class="col-lg-5 col-md-12 col-12 col-sm-12 col-12 p-0">
            <div class="d-none d-lg-block d-xl-block img-hover-zoom">
               <a href="prop-desc.php?mid=<?php echo $res['proid'];?>"><img class="cat-img d-none d-lg-block d-xl-block" src="admin/images/<?php echo strtr($name[0],'[]','++'); ?>" alt="..." style="width: 100%;height: 282px;object-fit: fill;object-position: center;border-top-left-radius: 15px;border-bottom-left-radius: 15px;">
               </a>
              </div>
              <a href="prop-desc.php?mid=<?php echo $res['proid'];?>">  <img class="d-block d-lg-none d-xl-none" src="admin/images/<?php echo strtr($name[0],'[]','++'); ?>" alt="..." style="width: 100%;height: 260px;object-fit: fill;object-position: center;border-top-left-radius: 10px;border-top-right-radius: 10px;">
              </a>
    ...
    <!----------title------------->
        ...
        <a href="prop-desc.php?mid=<?php echo $res['proid'];?>" style="font-size: 15px;font-weight: 700;color:#2e2e2e;">  <?php echo $res['title'] ?> 
