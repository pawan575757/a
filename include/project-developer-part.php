<?php 
                  ...
                  if(isset($_GET['did'])){
                    ...
                    $sql1 = "SELECT * FROM developer_master WHERE developerid = {$dev_id}";
...
//................................ Property Table -------------------------------//
$selectquery= " select * from projects WHERE projects.developer = {$dev_id} AND status = 1 ORDER BY projects.projid DESC LIMIT 20 " ;   
