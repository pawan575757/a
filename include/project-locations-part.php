<?php 
                  ...
                  if(isset($_GET['locid'])){
                    ...
                    $sql1 = "SELECT * FROM location_master WHERE locationid = {$loc_id}";
...
//................................ Property Table -------------------------------//
$selectquery= " select * from projects WHERE projects.location = {$loc_id} AND status = 1 ORDER BY projects.projid DESC LIMIT 20 " ;   
